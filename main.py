...
def gender(update: Update, context: CallbackContext) -> int:
    ...
    reply_keyboard = [['MARC'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT'], ['SANT']]
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            COMUNE: [MessageHandler(Filters.regex('^(SANT)$'), photo)],
            NODO1: [MessageHandler(Filters.all, nodo1)],
            NODO2: [MessageHandler(Filters.all, completa)],
